...
public interface ProgramTranslator {
     ...
     * @return 翻译所得的语法单元集合
     */
    Set<ObjectModel> translate(ObjectModel objectModel) throws TranslateErrorException;
     ...
     * @return 翻译所得的逻辑程序
     */
    ObjectModel translateProgram(ObjectModel program) throws TranslateErrorException;
}
